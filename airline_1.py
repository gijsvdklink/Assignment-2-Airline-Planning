...
distance_matrix_file = "distance_matrix_with_city_names.csv"
distance_df.to_csv(distance_matrix_file, index=True, header=True)

print(f"\nDistance matrix with city names saved to {distance_matrix_file}.")
