...
airport_data2 = airport_data2.rename(columns={departure_column: "Departure", destination_column: "Destination"})
...
fra_related_rows = airport_data2[
    (airport_data2["Departure"] == "FRA") | (airport_data2["Destination"] == "FRA")
]
...
fra_related_rows.to_csv('correct_data.csv', index=False)
